...
// Define RSS_FEEDS array that was missing
export const RSS_FEEDS: NewsSource[] = [
  ...
  // Hindi sources
  {
    id: 'aaj-tak',
    name: 'Aaj Tak',
    description: 'Hindi news channel providing latest news from India and around the world.',
  ...
  },
  {
    id: 'ndtv-hindi',
    name: 'NDTV Hindi',
    description: 'NDTV Hindi provides latest news in Hindi from India and world.',
    url: 'https://hindi.ndtv.com',
    category: 'general',
    language: 'hi',
    country: 'in',
    region: 'South Asia',
  ...
  // Regional sources
  {
    ...
    description: 'Leading Malayalam newspaper and news portal from Kerala.',
  ...
  },
  {
    id: 'eenadu',
    name: 'Eenadu',
    description: 'Leading Telugu newspaper and news portal.',
  ...
  },
  {
    id: 'dinamalar',
    name: 'Dinamalar',
    description: 'Leading Tamil newspaper and news portal.',
